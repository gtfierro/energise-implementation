...
# =============================================================================
            ...
            #3.3
# =============================================================================
            alph = 0.001         # Leo CIL: 0.45
            beta = 0.001         # Leo CIL: 0.75
...
# =============================================================================
 ...
 #'inverter' or 'load'
    ...
    def modbustoOpal_quadrant(self, Pcmd_kVA, Qcmd_kVA, Pact, Qact, act_idxs, client):
        ...
        act_idxs_registers = []
        pq_changed = []
        'ORIGINAL IMPLEMENTATION BY LEO BELOW - checking previous values is causing some issues, so rewriting without this'
